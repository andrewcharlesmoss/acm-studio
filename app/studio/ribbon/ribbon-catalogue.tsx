  ...
  return <main className="rl-shell">
    ...
    <div className="rl-layout">
      ...
      <aside className="rl-inspector" aria-label="Inspector">{section === "Icons" ? <>
        ...
        <details><summary>Provenance and source</summary><p>{iconMetadata[icon].provenance}</p><code>acm-icons/masters/{icon}.svg</code><p>Three editable scale groups. ACM icon specification v0.4.0.</p></details>
      </> : <>
