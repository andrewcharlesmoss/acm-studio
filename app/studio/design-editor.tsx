...
export function DesignEditor() {
  ...
  return <div className="design-shell" onPaste={handlePaste}>
    ...
    <Pane trackClassName="design-pages-track" className="design-pages" bodyClassName="design-pages-body" label="Design pages and layers" side="left" width={224} collapsed={pagesCollapsed} onCollapsedChange={setPagesCollapsed} collapseIcon={<StudioIcon name="chevron-right" size={18} />}
      ...
      <Pane trackClassName="design-properties-track" className="design-inspector" bodyClassName="design-inspector-body" label="Design properties" side="right" width={260} collapsed={inspectorCollapsed} onCollapsedChange={setInspectorCollapsed} collapseIcon={<StudioIcon name="chevron-right" size={18} />} header={<h2 className="design-properties-heading">Properties</h2>}>
