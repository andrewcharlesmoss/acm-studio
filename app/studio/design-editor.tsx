...
export function DesignEditor() {
  ...
  return <div className="design-shell" onPaste={handlePaste}>
    ...
    <button type="button" className="design-pane-collapse design-pane-collapse-left" onClick={() => setPagesCollapsed((value) => !value)} aria-expanded={!pagesCollapsed} aria-controls="design-pages-panel" aria-label={pagesCollapsed ? "Show pages and layers" : "Hide pages and layers"}><StudioIcon name={pagesCollapsed ? "arrow-right" : "arrow-left"} size={22} /></button>
    <button type="button" className="design-pane-collapse design-pane-collapse-right" onClick={() => setInspectorCollapsed((value) => !value)} aria-expanded={!inspectorCollapsed} aria-label={inspectorCollapsed ? "Show properties" : "Hide properties"}><StudioIcon name={inspectorCollapsed ? "arrow-left" : "arrow-right"} size={22} /></button>
