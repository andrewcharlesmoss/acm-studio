...
function InspectorAccordionSection({ kind, title, detail, children }: { kind: StudioDocument["kind"]; title: string; detail?: string; children: ReactNode }) {
  const [open, setOpen] = useState(true);
  const contentId = useId();
  return <section className="inspector-accordion-section" data-document-kind={kind}>
    ...
    <div id={contentId} className="inspector-accordion-content" hidden={!open}>{children}</div>
  </section>;
}
