...
export function TemplateWorkspace() {
  ...
  return <div className="studio-shell template-shell">
    ...
    {templates.syncConflict ? <div className="template-status" role="alert">Conflicting template changes need review. <button type="button" onClick={() => void templates.resolveSyncConflict("theirs")}>Use Other Change</button><button type="button" onClick={() => void templates.resolveSyncConflict("mine")}>Use My Change</button></div> : null}
    ...
    <main className="studio-workspace template-workspace">
      <aside className="studio-library"><a className="library-tool-button" href="/studio"><StudioIcon name="pencil" /><strong>Content</strong><small>Pages and posts</small></a><button className="library-tool-button is-active" type="button" onClick={library}><StudioIcon name="block" /><strong>Templates</strong><small>Shared presentation</small></button>
