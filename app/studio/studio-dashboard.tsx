      ...
      <main className="dashboard-main">
        ...
        <section className="dashboard-section dashboard-tools" aria-labelledby="tools-title">
          ...
          <div className="dashboard-tool-grid">
            ...
            <a className="dashboard-tool-card" href="/studio/panes"><span className="dashboard-tool-icon" aria-hidden="true"><StudioIcon name="archive" /></span><span><strong>Pane Library</strong><small>Explore pane structures and collapse controls.</small></span><StudioIcon name="arrow-right" size={18} /></a>
