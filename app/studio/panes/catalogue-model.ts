...
export const paneExamples: readonly PaneDefinition[] = [
  ...
  { id: "inspector", label: "Editor Inspector", side: "right", width: 300, description: "Tabbed document, block and style properties.", tabs: ["Document", "Block", "Styles"], toolbar: false, footer: false, source: "app/studio/studio-inspectors.tsx", sourceComponent: "StudioInspector" },
