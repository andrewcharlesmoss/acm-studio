...
export function BlockField({ block, rootBlocks = [block], document, selectedBlockId, hoveredBlockId, mediaUrl, coverImageUrl, onOpenCoverMediaLibrary, onRemoveCoverImage, onTableCellFocus, onTextSelection, onLinkActivate, onChange }: { block: ContentBlock; rootBlocks?: ContentBlock[]; document?: StudioDocument; selectedBlockId?: string | null; hoveredBlockId?: string | null; mediaUrl?: string; coverImageUrl?: string; onOpenCoverMediaLibrary?: () => void; onRemoveCoverImage?: () => void; onTableCellFocus: (rowIndex: number, columnIndex: number) => void; onTextSelection: (selection: TextSelection | null) => void; onLinkActivate: (selection: TextSelection) => void; onChange: (block: ContentBlock) => void }) {
